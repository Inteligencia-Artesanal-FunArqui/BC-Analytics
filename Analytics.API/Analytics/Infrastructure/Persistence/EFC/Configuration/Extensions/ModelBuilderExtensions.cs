...
namespace OsitoPolar.Analytics.Service.Infrastructure.Persistence.EFC.Configuration.Extensions;
...
public static class ModelBuilderExtensions
{
    public static void ApplyAnalyticsConfiguration(this ModelBuilder builder)
    {
        ...
        builder.Entity<TemperatureReading>(entity =>
        {
            ...
            // NOTE: No FK to Equipment - cross-bounded context reference
            // EquipmentId is just an integer reference to Equipment Service
